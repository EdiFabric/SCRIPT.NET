Thank you for downloading EdiFabric's NCPDP SCRIPT examples
...
The serial key is included in the file serial.key in folder edifabric-trial. Ensure it is there and that the file is not empty. The serial key is loaded in the file SerialKey.cs in project EdiFabric.Examples.NCPDP.Script.Common. 
...
5. Getting started
To get started, set project EdiFabric.Examples.NCPDP.Script.Demo as the startup project, open Program.cs and follow the instructions there. This project allows you to quickly translate your own NCPDP files.
...
https://support.edifabric.com/hc/en-us/articles/360017128397-NCPDP-SCRIPT-Version-10-6
